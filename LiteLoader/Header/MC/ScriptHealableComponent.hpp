...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTHEALABLECOMPONENT
public:
    class ScriptHealableComponent& operator=(class ScriptHealableComponent const &) = delete;
    ScriptHealableComponent(class ScriptHealableComponent const &) = delete;
    ScriptHealableComponent() = delete;
#endif

public:
    /*0*/ virtual ~ScriptHealableComponent();
...
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_SCRIPTHEALABLECOMPONENT
#endif

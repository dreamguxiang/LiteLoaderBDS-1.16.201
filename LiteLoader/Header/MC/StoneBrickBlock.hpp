...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_STONEBRICKBLOCK
public:
    class StoneBrickBlock& operator=(class StoneBrickBlock const &) = delete;
    StoneBrickBlock(class StoneBrickBlock const &) = delete;

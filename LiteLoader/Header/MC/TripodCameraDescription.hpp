...
public:
    struct TripodCameraDescription& operator=(struct TripodCameraDescription const &) = delete;
    TripodCameraDescription(struct TripodCameraDescription const &) = delete;

...
public:
    struct MoveControlSkipDescription& operator=(struct MoveControlSkipDescription const &) = delete;
    MoveControlSkipDescription(struct MoveControlSkipDescription const &) = delete;

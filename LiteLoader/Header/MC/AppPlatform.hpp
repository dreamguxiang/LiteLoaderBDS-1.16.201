...
public:
    ...
    MCVAPI bool canSupportApp(enum class ExternalApp) const;
    ...
    MCVAPI class IFileAccess & getFileAccess(enum class ResourceFileSystem);
    ...
    MCVAPI enum class Social::MultiplayerServiceIdentifier getPlatformMultiplayerServiceIdentifier() const;
    ...
    MCVAPI bool hasAppInstalled(enum class ExternalApp) const;
    ...
    MCVAPI bool launchApp(enum class ExternalApp) const;
    ...
    MCVAPI void navigateToStoreForApp(enum class ExternalApp) const;
    ...
    MCVAPI bool requiresCheckGfxDriverVersion() const;

...
public:
    ...
    MCAPI static void appendEnchantToFormattedText(enum class Enchant::Type, std::string const &, std::string &);
    ...
    MCAPI static int getBestEnchantLevel(enum class Enchant::Type, class Mob const &, enum class EquipmentFilter);

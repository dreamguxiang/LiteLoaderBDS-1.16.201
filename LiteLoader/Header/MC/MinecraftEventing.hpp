...
public:
    ...
    MCVAPI void fireClubsEngagementEvent(enum class IMinecraftEventing::ClubsEngagementAction, enum class IMinecraftEventing::ClubsEngagementTargetType, char const *, struct Realms::RealmId, std::string);
    MCVAPI void fireClubsOpenFeedScreenEvent(enum class IMinecraftEventing::ClubsFeedScreenSource, struct Realms::RealmId, std::string);
    ...
    MCVAPI void fireEventAccountTransferStateChanged(std::string const &, enum class TransferState, std::string const &);
    ...
    MCVAPI void fireEventConnectionFailed(enum class IMinecraftEventing::ConnectionFailureReason);
    ...
    MCVAPI void fireEventSignInEdu(std::string const &, enum class ADRole, enum class IMinecraftEventing::EduSignInStage, std::string const &, std::vector<struct std::pair<std::string, std::string>> const &);
    MCVAPI void fireEventSignInToIdentity(enum class IMinecraftEventing::SignInAccountType, enum class IMinecraftEventing::SignInTrigger, bool, enum class IMinecraftEventing::SignInStage, enum class Social::SignInResult, std::string const &, std::string const &);
    ...
    MCVAPI void fireInAppCodeBuilderActivated(enum class IMinecraftEventing::OpenCodeMethod);
    MCVAPI void fireLegacyWorldUploadEvent(struct Legacy::WorldConversionReport const &, bool, enum class WorldConversionError);
    MCVAPI void fireLessonActionTaken(std::string const &, std::string const &, std::string const &, enum class IMinecraftEventing::EducationLessonAction);
    ...
    MCVAPI void fireServerConnectionEvent(enum class IMinecraftEventing::ServerConnectionOutcome, unsigned int, double, std::string const &);

...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTINTERACTCOMPONENT
public:
    class ScriptInteractComponent& operator=(class ScriptInteractComponent const &) = delete;
    ScriptInteractComponent(class ScriptInteractComponent const &) = delete;
    ScriptInteractComponent() = delete;
#endif
...
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_SCRIPTINTERACTCOMPONENT
#endif

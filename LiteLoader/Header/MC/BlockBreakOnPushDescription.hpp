...
struct BlockBreakOnPushDescription {
...
public:
    struct BlockBreakOnPushDescription& operator=(struct BlockBreakOnPushDescription const &) = delete;
    BlockBreakOnPushDescription(struct BlockBreakOnPushDescription const &) = delete;
...
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_BLOCKBREAKONPUSHDESCRIPTION
#endif

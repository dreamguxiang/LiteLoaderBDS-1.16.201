...
public:
    class SimpleHashStringFilterTest& operator=(class SimpleHashStringFilterTest const &) = delete;
    SimpleHashStringFilterTest(class SimpleHashStringFilterTest const &) = delete;

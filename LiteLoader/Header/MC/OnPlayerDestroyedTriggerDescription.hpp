...
struct OnPlayerDestroyedTriggerDescription {
...
public:
    struct OnPlayerDestroyedTriggerDescription& operator=(struct OnPlayerDestroyedTriggerDescription const &) = delete;
    OnPlayerDestroyedTriggerDescription(struct OnPlayerDestroyedTriggerDescription const &) = delete;

...
class ScriptEquippableComponent {

#define AFTER_EXTRA

#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTEQUIPPABLECOMPONENT
public:
    class ScriptEquippableComponent& operator=(class ScriptEquippableComponent const &) = delete;
    ScriptEquippableComponent(class ScriptEquippableComponent const &) = delete;
    ScriptEquippableComponent() = delete;
#endif

public:
    /*0*/ virtual ~ScriptEquippableComponent();
...
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_SCRIPTEQUIPPABLECOMPONENT
#endif

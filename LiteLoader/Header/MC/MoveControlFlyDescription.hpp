...
public:
    struct MoveControlFlyDescription& operator=(struct MoveControlFlyDescription const &) = delete;
    MoveControlFlyDescription(struct MoveControlFlyDescription const &) = delete;

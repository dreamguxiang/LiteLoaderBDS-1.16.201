...
public:
    struct SlimeMoveControlDescription& operator=(struct SlimeMoveControlDescription const &) = delete;
    SlimeMoveControlDescription(struct SlimeMoveControlDescription const &) = delete;

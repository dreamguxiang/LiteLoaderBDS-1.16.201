...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTARMORCONTAINERCOMPONENT
public:
    class ScriptArmorContainerComponent& operator=(class ScriptArmorContainerComponent const &) = delete;
    ScriptArmorContainerComponent(class ScriptArmorContainerComponent const &) = delete;
    ScriptArmorContainerComponent() = delete;
#endif
...
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_SCRIPTARMORCONTAINERCOMPONENT
#endif

...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTNAMEABLECOMPONENT
public:
    class ScriptNameableComponent& operator=(class ScriptNameableComponent const &) = delete;
    ScriptNameableComponent(class ScriptNameableComponent const &) = delete;
    ScriptNameableComponent() = delete;
#endif
...
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_SCRIPTNAMEABLECOMPONENT
#endif

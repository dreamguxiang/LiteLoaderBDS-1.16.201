...
//private:
    ...
    MCAPI void _findClosestDweller(class Actor *, class Actor *&, float &, class std::unordered_map<struct ActorUniqueID, struct Village::DwellerData, struct std::hash<struct ActorUniqueID>, struct std::equal_to<struct ActorUniqueID>, class std::allocator<struct std::pair<struct ActorUniqueID const, struct Village::DwellerData>>> const &) const;

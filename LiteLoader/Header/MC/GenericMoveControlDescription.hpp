...
public:
    struct GenericMoveControlDescription& operator=(struct GenericMoveControlDescription const &) = delete;
    GenericMoveControlDescription(struct GenericMoveControlDescription const &) = delete;

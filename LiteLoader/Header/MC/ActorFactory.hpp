...
//private:
    ...
    MCAPI std::unique_ptr<class Actor> _constructActor(struct ActorDefinitionIdentifier const &, class Vec3 const &, class Vec2 const &) const;
    MCAPI std::unique_ptr<class Actor> _constructActorHelper(struct ActorDefinitionIdentifier const &, class Vec3 const &, class Vec2 const &) const;

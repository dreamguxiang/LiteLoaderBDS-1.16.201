...
//private:
    MCAPI void evictRiders(class CommandOrigin const &, class CommandOutput &) const;
    ...
    MCAPI void summonRide(class CommandOrigin const &, class CommandOutput &) const;
    MCAPI void summonRider(class CommandOrigin const &, class CommandOutput &) const;

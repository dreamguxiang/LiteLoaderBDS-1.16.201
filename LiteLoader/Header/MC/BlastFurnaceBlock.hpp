...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_BLASTFURNACEBLOCK
public:
    class BlastFurnaceBlock& operator=(class BlastFurnaceBlock const &) = delete;
    BlastFurnaceBlock(class BlastFurnaceBlock const &) = delete;

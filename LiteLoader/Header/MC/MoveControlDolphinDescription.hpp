...
public:
    struct MoveControlDolphinDescription& operator=(struct MoveControlDolphinDescription const &) = delete;
    MoveControlDolphinDescription(struct MoveControlDolphinDescription const &) = delete;

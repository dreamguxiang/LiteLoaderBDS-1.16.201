...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTDAMAGESENSORCOMPONENT
public:
    class ScriptDamageSensorComponent& operator=(class ScriptDamageSensorComponent const &) = delete;
    ScriptDamageSensorComponent(class ScriptDamageSensorComponent const &) = delete;
    ScriptDamageSensorComponent() = delete;
#endif
...
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_SCRIPTDAMAGESENSORCOMPONENT
#endif

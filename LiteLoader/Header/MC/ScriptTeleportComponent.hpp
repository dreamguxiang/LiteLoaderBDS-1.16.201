...
class ScriptTeleportComponent {

#define AFTER_EXTRA

#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTTELEPORTCOMPONENT
public:
    class ScriptTeleportComponent& operator=(class ScriptTeleportComponent const &) = delete;
    ScriptTeleportComponent(class ScriptTeleportComponent const &) = delete;
    ScriptTeleportComponent() = delete;
#endif

public:
    /*0*/ virtual ~ScriptTeleportComponent();
...
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_SCRIPTTELEPORTCOMPONENT
#endif

...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTTAGCOMPONENT
public:
    class ScriptTagComponent& operator=(class ScriptTagComponent const &) = delete;
    ScriptTagComponent(class ScriptTagComponent const &) = delete;
    ScriptTagComponent() = delete;
#endif
...
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_SCRIPTTAGCOMPONENT
#endif
